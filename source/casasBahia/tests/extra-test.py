...
async def fetch_extra_data(session, page, max_retries=3, delay=1):
    url = "https://api-partner-prd.extra.com.br/api/v2/Search"
    params = {
        "ResultsPerPage": "37",
        "ApiKey": "extra",
        "Filter": "L139420",
...
async def fetch_preco_produtos(max_retries=3, delay=1):
    ...
    url = "https://api.extra.com.br/merchandising/oferta/v1/Preco/Produto/PrecoVenda/"
    params = {
        "idRegiao": "",
...
async def juntar_e_exibir_produtos_extra():
