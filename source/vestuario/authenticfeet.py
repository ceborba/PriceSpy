...
class DatabaseManager:
    def __init__(self):
        self.conn = sqlite3.connect('authenticfeet_products.db')
...
class AuthenticFeetMonitor:
    def __init__(self):
        self.base_url = "https://www.authenticfeet.com.br/_v/segment/graphql/v1"
        self.variables = [
            ""
        ]
        self.headers = {
            "accept": "application/json",
            "content-type": "application/json",
            "referer": "https://www.authenticfeet.com.br/outlet",
    ...
    async def fetch_page(self, variables):
        ...
        params = {
            ...
            "domain": "store",
            "locale": "pt-BR",
            "__bindingId": "1884b05d-c318-4381-b927-de348a7d8b6d",
        ...
        try:
            async with aiohttp.ClientSession() as session:
                async with session.get(url, params=params, headers=self.headers) as response:
                    print(f"AuthenticFeet - Status Code: {response.status}")
    ...
    def enviar_webhook_discord(self, nome_produto, preco_antigo, preco_novo, link_produto, link2, desconto_percentual, novo_produto=False):
        ...
        embed.add_embed_field(name="Loja", value=f"AuthenticFeet")
                    ...
                    if products:
                        ...
                        for product in products:
                            try:
                                ...
                                link = f"https://www.authenticfeet.com.br{product['link']}"
                                ...
                                for item in product['items']:
                                    ...
                                    if existing_product:
                                        ...
                                        if selling_price_low != old_selling_price:
                                            ...
                                            if desconto_percentual >= 30:
                                                link2 = f"https://www.authenticfeet.com.br/checkout/cart/add?sku={item_id}&qty=1&seller=1&sc=1"
...
async def monitor_authenticfeet():
    monitor = AuthenticFeetMonitor()
    try:
