...
class MagicFeetMonitor:
    def __init__(self):
        ...
        self.variables = [
            ""
        ]
        self.headers = {
    ...
    async def fetch_page(self, variables):
        ...
        params = {
            ...
            "domain": "store",
            "locale": "pt-BR",
            "__bindingId": "144df838-4432-4c06-868c-9866048082a0",
