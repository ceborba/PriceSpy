    ...
    while True:
        ...
        get_headers = {
            **common_headers,
            ...
            "sec-ch-ua-mobile": "?0",
            "x-amzn-encrypted-slate-token": "",
            "x-api-csrf-token": "1@gzBq0YZwoPqMMVfLCgCfzvYnSeU0m1hKdfITq+oqUdSXAAAAAQAAAABnqmbecmF3AAAAAGfA1H5nd8xGEcC33NuKVw==@RQ2CWZ",
