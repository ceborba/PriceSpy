...
def send_discord_webhook2(item, alert="Alteração de Preço Detectada"):
    ...
    yellow_circle = "🟡"
    gray_circle = "⚪"  # Adicionando uma bolinha cinza para 0% de desconto
    webhook_url = 'https://discord.com/api/webhooks/1301756540822356009/4n1EMi6adUfl2PmgFcMSAOv1GycUS1s6CfOuYpSx7KLAIEZY9NiVhM__ugfk38om3IWS'
