...
class CompraCertaWatcher:
    def __init__(self):
        self.session = tls_client.Session(
            client_identifier="chrome_120",
            random_tls_extension_order=True
        )
        self.conn = sqlite3.connect('prices_compracerta.db')
    ...
    def enviar_webhook_discord(self, nome_produto, preco_antigo, preco_novo, link_produto, link_carrinho, desconto_percentual, novo_produto=False):
        webhook_url = self.webhooks["novos"] if novo_produto else print(f"Produto fora das métricas")
        ...
        embed.add_embed_field(name="Loja", value="CompraCerta")
    ...
    def fetch_products(self, page=0):
        params = {
            ...
            'variables': json.dumps({
                ...
                "from": page * 12,
                "to": (page + 1) * 12 - 1,
                "selectedFacets": [{ "key": "ft", "value": "outlet" }],
                "operator": "and",
                "fuzzy": "0",
        ...
        headers = {
            'authority': 'www.compracerta.com.br',
            'sec-ch-ua': '"Not A(Brand";v="8", "Chromium";v="132", "Google Chrome";v="132"',
            'content-type': 'application/json',
            'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/132.0.0.0 Safari/537.36',
            'accept': '*/*',
            'referer': 'https://www.compracerta.com.br/outlet',
        }
        
        try:
            response = self.session.get(
                'https://www.compracerta.com.br/_v/segment/graphql/v1',
                params=params,
                headers=headers
            )
                ...
                for item in product['items']:
                    ...
                    for seller in item['sellers']:
                        ...
                        products.append({
                            ...
                            'link': f"https://www.compracerta.com.br{product['link']}",
                            'voltagem': voltagem,
        ...
        for product in products:
            ...
            if result is None:
                if product['estoque'] > 0:
                    ...
                    link_carrinho = f"https://www.compracerta.com.br/checkout/cart/add?sku={product['item_id']}&qty=1&seller=1&sc=5"
    ...
    def monitor_compracerta():
        monitor

if __name__ == "__main__":
    monitor_compracerta = CompraCertaWatcher()
    monitor_compracerta.run(interval=300, max_pages=30)# Executar a cada 10 minutos, máximo de 10 páginas